...
BLOG_AUTHOR = "Drexel Wireless System Lab"  # (translatable)
BLOG_TITLE = "BeamViewer"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://www.beamviewer.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.beamviewer.io/"
BLOG_EMAIL = "info@wireless.ece.drexel.edu"
BLOG_DESCRIPTION = "Information Site for BeamViewer Mobile AR Framework"  # (translatable)
...
LOGO_URL = 'images/beamviewer_logo.resized.jpg'
